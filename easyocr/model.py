...
class Model(nn.Module):
    def __init__(self, input_channel, output_channel, hidden_size, num_class, image_height, image_width, num_fiducial):
        super(Model, self).__init__()
        # self.opt = opt
        """ Transformation """
        self.Transformation = TPS_SpatialTransformerNetwork(
            F=num_fiducial,
            I_size=(image_height, image_width),
            I_r_size=(image_height, image_width),
